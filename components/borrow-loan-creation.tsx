              ...
              <div className="flex items-center gap-2">
                ...
                <Dialog open={isWalletDialogOpen} onOpenChange={setIsWalletDialogOpen}>
                  <DialogTrigger asChild>
                    <Button className="h-8 px-6 bg-[#1358EC] text-white hover:bg-[#104BCA]">
                      WALLET
                    </Button>
                  </DialogTrigger>
                  <DialogContent>
                    ...
                    />
                    <DialogFooter>
                      <Button onClick={() => handleSetWalletAddress(receiverAddress)} className="text-black dark:text-white hover:bg-blue-600 dark:hover:bg-blue-900 bg-white dark:bg-blue-950">Set Address</Button>
                    </DialogFooter>
                  </DialogContent>
                </Dialog>
              </div>
        ...
        <DialogContent className="max-w-md">
          ...
          <DialogFooter className="flex justify-center mt-4 gap-4">
            ...
            <Button 
              ...
              className="bg-blue-600 text-white hover:bg-blue-700 dark:bg-blue-950"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
