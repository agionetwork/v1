...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-gradient-to-b from-white via-blue-100 to-blue-300 dark:bg-gradient-to-b dark:from-gray-950 dark:to-blue-950/30 text-white dark:text-gray-200">
