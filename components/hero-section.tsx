...
export function HeroSection() {
  ...
  // Se não estiver montado, renderiza sem animações para evitar problemas de hidratação
  if (!mounted) {
    return (
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center space-y-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-[#1358EC] hover:bg-blue-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105" asChild>
                <Link href="/borrow-lend">
                  TRY BETA
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
              <Button size="lg" variant="outline" className="bg-white hover:bg-gray-100 text-blue-600 border-blue-600 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105" asChild>
                <Link href="/borrow-lend">
                  LOAN OFFERS
                </Link>
              </Button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-4xl">
              <div className={`flex items-center space-x-4 p-6 rounded-xl ${cardBg} backdrop-blur-sm border ${cardBorder} shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105`}>
    ...
    <section className="relative w-full min-h-screen flex items-center justify-center py-20 md:py-32 text-foreground overflow-hidden">
      <div className="container px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center space-y-8 text-center">
          ...
          >
            <motion.div 
              className={`flex items-center space-x-4 p-6 rounded-xl ${cardBg} backdrop-blur-sm border ${cardBorder} shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105`}
              whileHover={{ y: -5 }}
